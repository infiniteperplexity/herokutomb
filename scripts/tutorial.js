  ...
  "use strict";
    ...
    new Tutorial({
      ...
      instructions: [
        ...
        " ",
        "%c{cyan}Press 5 on the numeric keypad several times, until your zombie emerges.  If you have no numeric keypad, press Control+Space to wait (actually, you can usually just press Space, but in some situations the Space Bar has other functions.)"
      ],
      listens: ["Complete"],
      skip: "AssignAJob",
      trigger: function(event) {
    ...
    //!!!!! Creates a problem in that it hides the menu....
    new Tutorial({
    ...
    new Tutorial({
      ...
      backupInstructions: ["%c{cyan}Press J to assign a job, press D to harvest, and wait for your zombies to harvest some wood."],
      listens: ["Complete"],
      trigger: function(event) {
